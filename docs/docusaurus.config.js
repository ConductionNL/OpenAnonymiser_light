...
/**
 * OpenAnonymiser Light documentation site.
 *
...
const config = createConfig({
  title: 'OpenAnonymiser Light',
  tagline: 'Lightweight CPU-only document anonymisation for government and SMB workflows. Powers the OpenAnonymiser ExApp shipped from openanonymiser-light-exapp.',
  url: 'https://openanonymiser.conduction.nl',
  baseUrl: '/',

  organizationName: 'ConductionNL',
  projectName: 'OpenAnonymiser_light',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://codeberg.org/Conduction/OpenAnonymiser_light/src/branch/main/docs/',
        },
        blog: false,
        theme: {
  ...
  navbar: {
    items: [
      ...
      {
        href: 'https://codeberg.org/Conduction/OpenAnonymiser_light',
        label: 'Codeberg',
        position: 'right',
      },
